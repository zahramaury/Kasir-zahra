            ...
            <div class="col-md-4 mb-4">
                <div class="card text-white bg-primary shadow">
                    <div class="card-body text-center">
                        ...
                        <h3 class="fw-bold fs-15"><?php echo e($member); ?></h3>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kasir\resources\views/dashboard.blade.php ENDPATH**/ ?>