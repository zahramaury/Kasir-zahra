...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Masukkan Email" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="Masukkan Nama">
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" placeholder="Masukkan Password" autocomplete="off">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kasir\resources\views/User/tambah.blade.php ENDPATH**/ ?>